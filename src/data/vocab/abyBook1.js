...
export const abyBook1 = [
  ...
  // ---- Unit 3: Klassenraum & Studium ----
  { id: 'aby-class-1', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: ['ق', 'ل', 'م'], rootMeaning: 'Schreibrohr', ar: 'قَلَم', bare: 'قلم', translit: 'qalam', de: 'Stift' },
  { id: 'aby-class-2', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: ['ك', 'ت', 'ب'], rootMeaning: 'schreiben', ar: 'كِتَاب', bare: 'كتاب', translit: 'kitāb', de: 'Buch' },
  { id: 'aby-class-3', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: ['ب', 'و', 'ب'], rootMeaning: 'Tür', ar: 'بَاب', bare: 'باب', translit: 'bāb', de: 'Tür' },
  { id: 'aby-class-4', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: null, ar: 'نَافِذَة', bare: 'نافذة', translit: 'nāfidha', de: 'Fenster' },
  { id: 'aby-class-5', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: ['ك', 'ر', 'س'], rootMeaning: 'Sitz', ar: 'كُرْسِيّ', bare: 'كرسي', translit: 'kursī', de: 'Stuhl' },
  { id: 'aby-class-6', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
  ...
  { id: 'aby-class-7', bookId: 'aby-1', unit: 'u3', unitDe: '٣ · Klassenraum & Studium', pos: 'noun',
    root: ['د', 'ر', 'س'], rootMeaning: 'lernen, studieren', ar: 'مَدْرَسَة', bare: 'مدرسة', translit: 'madrasa', de: 'Schule' },

  // ---- Unit 4: Das Haus ----
  { id: 'aby-home-1', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
    root: ['ب', 'ي', 'ت'], rootMeaning: 'übernachten', ar: 'بَيْت', bare: 'بيت', translit: 'bayt', de: 'Haus' },
  { id: 'aby-home-2', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
    root: null, ar: 'غُرْفَة', bare: 'غرفة', translit: 'ghurfa', de: 'Zimmer' },
  { id: 'aby-home-3', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
    root: null, ar: 'مَطْبَخ', bare: 'مطبخ', translit: 'maṭbakh', de: 'Küche' },
  { id: 'aby-home-4', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
    root: null, ar: 'سَرِير', bare: 'سرير', translit: 'sarīr', de: 'Bett' },
  { id: 'aby-home-5', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
    root: ['م', 'ي', 'ه'], rootMeaning: 'Wasser', ar: 'مَاء', bare: 'ماء', translit: 'māʾ', de: 'Wasser' },
  { id: 'aby-home-6', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
  ...
  { id: 'aby-home-7', bookId: 'aby-1', unit: 'u4', unitDe: '٤ · Das Haus', pos: 'noun',
